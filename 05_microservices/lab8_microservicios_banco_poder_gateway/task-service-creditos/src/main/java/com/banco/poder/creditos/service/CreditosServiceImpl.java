...
public class CreditosServiceImpl implements CreditosService {
	...
	public CreditosDto guardar(CreditosDto creditosDto) {
		creditosDto.setFecha(new Date().toString());
			...
			/*
			 * Añadir logica de negocio para validar si el cliente existe a travéz de una llamada remota
			 * Tarea 1
			 */
		...
		/*
		 * Envia solicitud de autorizacion para el area de verificacion de los creditos bancarios
		 */
		aprobacionesProducer.sendMessage(json.toJson(credito));
		log.info(">>>Envia solicitud de autorizacion para el area de verificacion de los creditos bancarios ok");
